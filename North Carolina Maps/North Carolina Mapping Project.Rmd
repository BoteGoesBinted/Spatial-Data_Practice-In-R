...
equal.pop <- pop2020 |>
  ...
  tm_layout(frame = TRUE, frame.color = "white",
            outer.margins = 0,
...
female |>
  tm_shape() +
  tm_polygons(fill = "percent.female",
              style="jenks",
  ...
  tm_credits("BoteGoesBinted, September 2025\n Data: 2020 US Census\n GEOG 15",
             position = tm_pos_in("left","bottom")
             )
```
...
female |>
  ...
  tm_credits("BoteGoesBinted, 2025\n Data: 2020 US Census\n GEOG 215",
             position = tm_pos_in("left","bottom")
             )
...
sameSexPartner |>
  tm_shape() +
  tm_polygons(fill="percent.sameSexPartner",
